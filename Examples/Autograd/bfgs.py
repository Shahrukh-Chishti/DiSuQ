...
def numpyProfiling(N,El=10.,Ec=100.,Ej=50):
    ...
    init_pos = El,Ej,Ec
    res = minimize(loss, init_pos, method = 'L-BFGS-B', options = {'maxiter': n_iter})
    #print(res)
...
if __name__ == "__main__":
    ...
    plotCompare(bases,{'torch':torch_mem,'numpy':numpy_mem},'Optimization Memory Profile','basis','memory',save=True)
