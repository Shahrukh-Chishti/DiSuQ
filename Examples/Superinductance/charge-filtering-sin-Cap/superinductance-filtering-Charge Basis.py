...
def execute(gamma):
    ...
    plotCompare(array_range,{'array':path_array[:,0],'quasi':path_approx[:,0],'cosine':path_cosine[:,0]},'Quasi approximation-E10-Charge Basis-Gamma'+str(gamma),'N','E10',export='pdf',size=(600,600))
    plotCompare(array_range,{'array':path_array[:,1],'quasi':path_approx[:,1],'cosine':path_cosine[:,1]},'Quasi approximation-E21-Charge Basis-Gamma'+str(gamma),'N','E21',export='pdf',size=(600,600))
