...
def execute(gamma):
    ...
    Basis['11'] = [1,1,1,1,2,2,2,2,2,2,2]
    Basis['10'] = [1,2,2,2,2,2,2,2,2,2]
    Basis['9'] = [2,2,2,2,2,2,2,3,3]
    Basis['8'] = [2,3,3,3,3,3,3,3]
    Basis['7'] = [3,4,4,4,4,4,4]
    Basis['6'] = [5,6,6,6,6,6]
    Basis['5'] = [9,10,10,10,10]
    Basis['4'] = [18,18,18,18]
    Basis['3'] = [72,72,72]
    Basis['2'] = [725,725]
    ...
    plotTrajectory(array_range,{'array':path_array,'approx':path_approx,'cosine':path_cosine},'Quasi approximation-Flux Filter Basis-Gamma'+str(gamma),'E10','E21',html=True,export='pdf',size=(600,600))
