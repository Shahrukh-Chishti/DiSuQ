...
from DiSuQ.Torch.components import capE,indE,e,h,complex
...
from DiSuQ.Torch.circuit import Kerman, hamiltonianEnergy, phase
...
circuit = Kerman(circuit,control_iD,basis,sparse=False)
N = circuit.basisSize()
